...
from server.api.upd_api import ParkingInfoResult, get_parking_image_url, router
from server.crud.cam_park import CRUDCameraParking
...
def test_get_parking_info_with_correct_geoposition(cam_park_fixture_for_api):
    ...
    assert response_json['prevCameraId'] == None, 'Неверно определена предыдущая камера'
